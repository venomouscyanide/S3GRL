...
for SEED in 1 2 3 4 5; do
  python seal_link_pred.py --dataset Pubmed --epochs 50 --seed $SEED --node_label zo --use_feature --num_layers 3 --sign_k 3 --data_appendix pubmed_k3_$SEED --model SIGN
done
for SEED in 1 2 3 4 5; do
  python seal_link_pred.py --dataset Pubmed --epochs 50 --seed $SEED --node_label zo --use_feature --num_layers 3 --sign_k -1 --data_appendix pubmed_k-1_$SEED --model SIGN
done
