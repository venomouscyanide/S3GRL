...
# attributed-Facebook
python seal_link_pred.py --dataset attributed-Facebook --train_gae --base_gae GCN --epochs 50 --split_val_ratio 0.05 --split_test_ratio 0.10 --runs 5
python seal_link_pred.py --dataset attributed-Facebook --train_gae --base_gae SAGE --epochs 50 --split_val_ratio 0.05 --split_test_ratio 0.10 --runs 5
