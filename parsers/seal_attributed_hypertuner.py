...
# TODO: refactor and make into one file for both attributed and non-attributed datasets
...
def parse_non_attributed_results(file_name):
    ...
    with open(f'attributed-SEAL-tuner-result.json', 'w', encoding='utf-8') as fp:
